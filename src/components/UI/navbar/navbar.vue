      ...
      <div class="flex h-16 justify-between">
        ...
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <button v-if="!isAuth" @click="login" type="button" class="relative inline-flex items-center gap-x-1.5 rounded-md bg-indigo-600 px-3 py-2 mr-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          ...
          <div v-if="isAuth"  class="hidden md:ml-4 md:flex md:flex-shrink-0 md:items-center">
